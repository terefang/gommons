...
// SnmpHost is the type that lets you do SNMP requests.
...
// NewSnmpHost creates a new snmpHost object. Opens a udp connection to the device that will be used for the SNMP packets.
func NewSnmpHost(target, community string, version SNMPVersion, timeout time.Duration, retries int) (*SnmpHost, error) {
	...
	return &SnmpHost{target, community, version, timeout, retries, conn}, nil
}

// NewSnmpHostOnConn creates a new snmpHost object from an existing net.Conn.
//
// It does not check if the provided target is valid.
func NewSnmpHostOnConn(target, community string, version SNMPVersion, timeout time.Duration, retries int, conn net.Conn) *SnmpHost {
	return &SnmpHost{target, community, version, timeout, retries, conn}
}
...
func (w SnmpHost) Get(oid Oid) (interface{}, error) {
	requestID := RandomRequestID()
	req, err := EncodeSequence([]interface{}{DerSequence, int(w.Version), w.Community,
		[]interface{}{SnmpGetRequest, requestID, 0, 0,
...
func (w SnmpHost) GetMultiple(oids []Oid) (map[string]interface{}, error) {
	requestID := RandomRequestID()
...
func (w SnmpHost) Set(oid Oid, value interface{}) (interface{}, error) {
	requestID := RandomRequestID()
	req, err := EncodeSequence([]interface{}{DerSequence, int(w.Version), w.Community,
...
func (w SnmpHost) SetMultiple(toset map[string]interface{}) (map[string]interface{}, error) {
	requestID := RandomRequestID()

	varbinds := []interface{}{DerSequence}
	for oid, value := range toset {
		varbinds = append(varbinds, []interface{}{DerSequence, oid, value})
	}
	req, err := EncodeSequence([]interface{}{DerSequence, int(w.Version), w.Community,
		[]interface{}{SnmpGetRequest, requestID, 0, 0, varbinds}})
...
func (w SnmpHost) GetNext(oid Oid) (*Oid, interface{}, error) {
	requestID := RandomRequestID()
	req, err := EncodeSequence([]interface{}{DerSequence, int(w.Version), w.Community,
...
func (w SnmpHost) GetBulk(oid Oid, maxRepetitions int) (map[string]interface{}, error) {
	requestID := RandomRequestID()
	req, err := EncodeSequence([]interface{}{DerSequence, int(w.Version), w.Community,
		[]interface{}{SnmpGetBulkRequest, requestID, 0, maxRepetitions,
			[]interface{}{DerSequence,
				[]interface{}{DerSequence, oid, nil}}}})
	if err != nil {
		return nil, err
...
func (w SnmpHost) GetBulkArray(oid Oid, maxRepetitions int) ([]SNMPValue, error) {
	requestID := RandomRequestID()
	req, err := EncodeSequence([]interface{}{DerSequence, int(w.Version), w.Community,
		[]interface{}{SnmpGetBulkRequest, requestID, 0, maxRepetitions,
			[]interface{}{DerSequence,
...
func (w SnmpHost) GetTable(oid Oid) (map[string]interface{}, error) {
	result := make(map[string]interface{})
	lastOid := oid.Copy()
...
// Close the net.conn in snmpHost.
func (w SnmpHost) Close() error {
	return w.conn.Close()
}
